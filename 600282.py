...
df = ts.pro_bar(ts_code='600282.SH', adj='qfq', start_date='20020101', end_date='20200227')
...
print("600282.SH stock' price for 20200228 is", knn.predict(x_predict))
